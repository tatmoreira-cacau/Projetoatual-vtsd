...
- **Perguntas em aberto para ela:** (1) as receitas 10 (cajá com cachaça), 11 (maracujá/manjericão, Callebaut), 12 (mate/hojichá, Callebaut), 13 (trufa amarga) e 14 (trufa ao leite, Callebaut) ficam ou saem? Ela não citou essas no áudio; (2) a regra da polpa, abaixo.
- **Regra da polpa (dita pela Tatiana, falta detalhar):** "quando usa polpa, a calculadora está errada; tem que reduzir: faz como o caramelo salgado, um caramelo com a polpa no lugar da água, creme de leite com polpa, e joga na ganache". Antes de mudar a família Fruta e as receitas com polpa, perguntar: quanto açúcar para cada 100 g de polpa, até onde reduzir, e se o creme entra no caramelo. **Não inventar esses números.**
