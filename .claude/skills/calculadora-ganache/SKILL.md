...
**Receitas da Tatiana (o que ela disse em 25/09, por áudio):** as receitas que ela mandou são: bico meio amargo, ao leite e branco/colorido; coco (com variações na mesma receita: doce de leite com nozes, doce de leite com coco, compota de abóbora); cheesecake de frutas vermelhas; limão siciliano com lavanda (exemplo de infusão: **troca o chá, a erva ou o tempero, nunca a fruta**); trufa de Earl Grey; ao leite com conhaque; pistache (pasta saborizante); caramelo salgado; e talvez cajá ou cupuaçu. A sessão anterior tinha trocado os sabores (laranja, canela, goiabada, alecrim, chá preto, licor de café, avelã). **Isso foi desfeito em 25/09:** receitas 1 a 9 voltaram aos sabores e às quantidades de `Receitas_integrais_calculadora.md`, convertidas para 100 g de chocolate e creme 30% (mesma água). O preparo está escrito com palavras próprias, a partir das apostilas, sem copiar o texto delas.
- **Perguntas em aberto para ela:** as receitas 11 (maracujá/manjericão, Callebaut), 12 (mate/hojichá, Callebaut), 13 (trufa amarga) e 14 (trufa ao leite, Callebaut) ficam ou saem? Ela não citou essas no áudio.
- **Regra da polpa (Tatiana, 25/09): polpa de fruta nunca vai crua; entra no caramelo, como na receita 15 (caramelo salgado).** Derrete o açúcar até âmbar, junta o creme e a polpa mornos, despeja no chocolate. Feito no "Monte a sua ganache" (família Fruta): açúcar = (creme + polpa) × 32/94, a medida da receita 15; a água continua pela régua; marcado "a testar". As receitas prontas 10 e 11 (com polpa) esperam a resposta dela sobre ficar ou sair antes de mudar.
